...
#+begin_src emacs-lisp
  (use-package minuet
    ...
    (plist-put minuet-openai-fim-compatible-options :end-poiint "http://localhost:11434/v1/completions")
    (plist-put minuet-openai-fim-compatible-options :name "Ollama")
    (plist-put minuet-openai-fim-compatible options :api-key "TERM")
    (plist-put minuet-openai-fim-compatible-options :model "qwen2.5-code:7b")
